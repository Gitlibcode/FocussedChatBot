    ...
    with st.chat_message("assistant"):
        with st.spinner("Thinking..."):
            try:
                ...
                blocked_keywords = ["Chief Ministers","Party leaders in India","Indian politics", "indian Politicians","Netagiti","local polictics","Mulayam singh","Kalyan Singh","Lalu Yadav","Akhilesh Yadav",
